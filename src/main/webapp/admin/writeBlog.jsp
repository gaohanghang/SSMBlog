...
<head>
    ...
    <script type="text/javascript" charset="UTF-8" src="${blog}/static/ueditor-1.4.3.3/ueditor.config.js"></script>

    <script type="text/javascript" charset="UTF-8" src="${blog}/static/ueditor-1.4.3.3/ueditor.all.js"></script>
